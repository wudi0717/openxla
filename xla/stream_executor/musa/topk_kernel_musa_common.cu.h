...
#ifndef XLA_STREAM_EXECUTOR_MUSA_TOPK_KERNEL_MUSA_COMMON_CU_H_
#define XLA_STREAM_EXECUTOR_MUSA_TOPK_KERNEL_MUSA_COMMON_CU_H_
...
#include "mp_ext_30_intrinsics.h"
...
#define REGISTER_TOPK_KERNEL(K_VAL, TYPE, VT)                                 \
  GPU_KERNEL_REGISTRY_REGISTER_KERNEL_STATICALLY(                             \
      TopKKernelMusa_K##K_VAL##_##TYPE##_##VT, KERNEL_TRAIT(K_VAL, TYPE, VT), \
...
#endif  // XLA_STREAM_EXECUTOR_MUSA_TOPK_KERNEL_MUSA_COMMON_CU_H_
