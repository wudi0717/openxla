...
#ifndef XLA_STREAM_EXECUTOR_MUSA_MUSA_DIAGNOSTICS_H_
#define XLA_STREAM_EXECUTOR_MUSA_MUSA_DIAGNOSTICS_H_
...
#endif  // XLA_STREAM_EXECUTOR_MUSA_MUSA_DIAGNOSTICS_H_
