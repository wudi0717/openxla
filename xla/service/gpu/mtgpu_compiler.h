...
#ifndef XLA_SERVICE_GPU_MTGPU_COMPILER_H_
#define XLA_SERVICE_GPU_MTGPU_COMPILER_H_
...
// MTGPUCompiler generates efficient GPU executables for MTGPU target.
class MTGPUCompiler : public GpuCompiler {
 public:
  MTGPUCompiler();
 ...
 private:
  MTGPUCompiler(const MTGPUCompiler&) = delete;
  MTGPUCompiler& operator=(const MTGPUCompiler&) = delete;
...
#endif  // XLA_SERVICE_GPU_MTGPU_COMPILER_H_
